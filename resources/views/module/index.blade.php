...
<div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="content-header">
                      <div class="row mb-2">
                          <div class="col-sm-6">
                              <h1 class="m-0 text-dark">Module Managment</h1>
                          </div><!-- /.col -->
                          <div class="col-sm-6">
                        ...
                        <div class="row m-4">
                            <div class="col-md-6">
                              @if(env('IS_MASTER_ADMIN') == true)
                                <div class="btn-group">
                                  <a href="{{route('module.create')}}" id="sample_editable_1_new" class="btn btn-primary">
                                  {{trans('message.add_new')}} 
                                  </a>
                                </div>
                                <div class="btn-group ">
                                  <a class="btn btn-danger" onclick="deleteAll('select_checkbox_value','{{route('module.delete_all')}}')">{{trans('message.delete_all_label')}}
                                  </a>
                                </div>
                              @endif
                              <div class="btn-group ">
                                <a class="btn btn-warning" style="color: white;" onclick="statusAll('select_checkbox_value','{{route('module.status_all')}}')">{{trans('message.status_all_label')}}
                                </a>
                              </div>
                            </div>
                        </div>
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"{{route('module.single_status_change')}}",
