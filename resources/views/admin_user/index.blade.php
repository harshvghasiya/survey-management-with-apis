            ...
            <div class="page-content">
                <!--breadcrumb-->
                  <div class="content-header">
                      <div class="row mb-2">
                          <div class="col-sm-6">
                              <h1 class="m-0 text-dark">Admin Users Managment</h1>
                          </div><!-- /.col -->
                          <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row m-4">
                            <div class="col-md-6">
                              <div class="btn-group">
                                <a href="{{route('admin_user.create')}}" id="sample_editable_1_new" class="btn btn-primary">
                                ...
                                @if(env('IS_MASTER_ADMIN')==true)
                                    <div class="btn-group ">
                                      <a class="btn btn-danger" onclick="deleteAll('select_checkbox_value','{{route('admin_user.delete_all')}}')">{{trans('message.delete_all_label')}}
                                      </a>
                                    </div>
                                @endif
                            
                              <div class="btn-group ">
                                <a class="btn btn-warning" style="color: white;" onclick="statusAll('select_checkbox_value','{{route('admin_user.status_all')}}')">{{trans('message.status_all_label')}}
                                </a>
                              </div>
                            </div>
                        </div>
                        <form id="table_form" class="table_form" name="form_data">
                            ...
                            <table id="users-table" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>First Name</th>
                                        <th>UserName</th>
                                        <th>{{trans('message.admin_role')}}</th>
    ...
    $(document).on("click","#active_inactive",function(){
      ...
      .then((willDelete) => {
        if (willDelete) {
              ...
              $.ajax({
                type:"POST",
                url:"{{route('admin_user.single_status_change')}}",
