...
<div class="container-fluid">
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">New Project Category</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                    <li class="breadcrumb-item active">New Project Category</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-6">
                                        <input type="text" name="category" value="{{ old('category') }}" class="form-control @error('category') is-invalid @enderror" placeholder="Category Name">
