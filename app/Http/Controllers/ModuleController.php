...
class ModuleController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.add_module_title');
       return view('module.addedit',compact('title'));
    }
    ...
    {
        $title=trans('message.module_title');
    ...
    */
    ...
    {
       $title=trans('message.module_edit');
       $module=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('module.addedit',compact('title','module','encryptedId'));  
    }
